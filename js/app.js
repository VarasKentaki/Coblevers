...
if(gen==="2")
return p.num>=152&&p.num<=251;

if(gen==="3")
return p.num>=252&&p.num<=386;

if(gen==="4")
return p.num>=387&&p.num<=493;

if(gen==="5")
return p.num>=494&&p.num<=649;

if(gen==="6")
return p.num>=650&&p.num<=721;

if(gen==="7")
return p.num>=722&&p.num<=809;

if(gen==="8")
return p.num>=810&&p.num<=905;
